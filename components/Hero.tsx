      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
            Pantau status online website penting Indonesia secara real-time. 
            Dapatkan informasi ketersediaan layanan digital pemerintah dengan mudah dan cepat.
          </p>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <div className="text-gray-600 dark:text-gray-300">Akurasi Monitoring</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-purple-600 dark:text-purple-400">24/7</div>
            <div className="text-gray-600 dark:text-gray-300">Monitoring Real-time</div>
          </div>
        </div>
      </div>
    </section>
